...
varTypes = ["categorical", "string", "categorical", "logical", "double", "double", "double", "double", "double", "double", "double"];
varNames = ["condition", "address","area", "fit_error", "mean_fr", "intrinsic_tau", "seasonal_tau", "intrinsic_tau_exp", "intrinsic_r2_exp", "intrinsic_mi_exp", "intrinsic_r2_lin"];
